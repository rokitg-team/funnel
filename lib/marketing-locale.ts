...
export const marketingCopy: Record<FunnelLocale, MarketingCopy> = {
  en: {
    ...
    promoLead:
      '<strong>Lifetime direct is the best-value path.</strong> Bypass Whop fees and lock access —',
    promoCta: 'Buy Lifetime Direct →',
    navSignals: 'SIGNALS ↓',
    ...
    heroTitleLast: 'PRINT',
    heroSub:
      'Real-time memecoin &amp; altcoin signals. Buy lifetime direct with crypto, or use Whop only if you want the fallback trial/monthly route.',
    ...
    pricingSub:
      'Lifetime direct is the featured offer. Trial and monthly stay available through Whop for buyers who want flexibility.',
    basicPeriod: 'start free',
    basicFeature1: 'Fastest way inside',
    basicFeature2: 'See live call flow',
    basicFeature3: 'Community access',
    basicFeature4: 'Upgrade later',
    basicCta: 'START FREE TRIAL →',
    featuredBadge: 'MOST POPULAR',
    proPeriod: 'per month via Whop',
    proFeature1: 'Full signal feed access',
    proFeature2: 'Entry, target, and stop levels',
    proFeature3: 'Whop billing convenience',
    proFeature4: 'Lower upfront commitment',
    proFeature5: 'Fallback path for hesitant buyers',
    proCta: 'JOIN MONTHLY →',
    elitePeriod: 'one-time via crypto',
    eliteFeature1: 'Lifetime access',
    eliteFeature2: 'Direct crypto checkout',
    eliteFeature3: 'Priority onboarding',
    eliteFeature4: 'Direct-buy savings',
    eliteFeature5: 'No recurring billing',
    eliteCta: 'BUY LIFETIME DIRECT →',
    finalTag: '// FINAL CALL',
    finalTitleBefore: 'STOP WATCHING.',
    finalTitleAccent: 'START WINNING.',
    finalSub:
      'If you already know the value, buy lifetime direct on-site. Whop stays there as the fallback, not the main event.',
    finalCta: 'LOCK LIFETIME ACCESS →',
  ...
  es: {
    ...
    promoLead:
      '<strong>$TON se duplicó después de compartirlo.</strong> No te pierdas la próxima —',
